...
public class TableauDeploy
{
	...
	public static void main(String[] args)
	{
		...
		JobType hwPublish = impl.invokePublishWorkbook(currentSiteId, defaultProject.getId(), "HelloWorld", hwWorkbook, true);

		/**
		 * Publish a packaged workbook
		 */
		File workbookFile = new File("../tableau-files/packaged-workbooks/Demo.twbx");
		JobType publishWorkbook = impl.invokePublishWorkbook(currentSiteId, defaultProject.getId(), "Test", workbookFile, true);
